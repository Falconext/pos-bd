...
const PLANTILLAS_COMPUTO: Record<string, Omit<PlantillaFichaTecnica, 'id' | 'activo' | 'fallback' | 'familia'>> = {
  ...
  laptop: {
    ...
    campos: [
      ...
      { key: 'pantalla', label: 'Pantalla', grupo: 'Pantalla', tipo: 'texto', orden: 400 },
      ...
      { key: 'duracionBateria', label: 'Duración de batería', grupo: 'Batería', tipo: 'numero', unidad: 'h', orden: 700 },
      { key: 'puertos', label: 'Puertos', grupo: 'Conectividad', tipo: 'textarea', orden: 800 },
      ...DIMENSIONES,
    ],
